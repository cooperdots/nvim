...
-- Set different cursors depending on mode
-- Also use custom highlight groups
...
vim.opt.guicursor = a .. b .. c .. d .. e

-- Set default tabstop and shiftwidth (indent size)
vim.opt.tabstop = 4
...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			end, { desc = "[S]earch [F]iles with Git" })
